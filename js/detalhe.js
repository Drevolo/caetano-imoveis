(function () {
  ...
  const enderecoMapa = imovel.localizacao + ', ' + imovel.cidade + ' - GO';
  ...
  app.innerHTML = `
    ...
    <div class="container pd-hero">
      <img src="${imovel.imagem}" alt="${imovel.titulo}" onerror="this.src='https://via.placeholder.com/1200x520/f7f8f9/b28e4a?text=Caetano+Im%C3%B3veis'" />
    ...
    <div class="container pd-grid">
      <div class="pd-main">
        <div class="pd-head">
          ...
          <h1>${imovel.titulo}</h1>
          <div class="pd-location"><i class="fa-solid fa-location-dot"></i> ${imovel.localizacao} - ${imovel.cidade}</div>
        </div>
        ...
        <div class="pd-box">
          ...
          <ul class="pd-facts">
            ...
            <li><span>Referência:</span> #${imovel.id}</li>
          </ul>
        </div>

        <div class="pd-box">
          <h2>Localização</h2>
          <p class="pd-desc">${imovel.localizacao} - ${imovel.cidade}</p>
          <div class="pd-map">
  ...
  function cardHTML(item, isFav) {
    const p = formatPrice(item.preco);
    return `
      <article class="property-card" data-id="${item.id}">
        <div class="property-thumb">
          <img src="${item.imagem}" alt="${item.titulo}" loading="lazy" onerror="this.src='https://via.placeholder.com/584x438/f7f8f9/b28e4a?text=Caetano+Im%C3%B3veis'" />
        ...
        <div class="property-body">
          ...
          <div class="property-location"><i class="fa-solid fa-location-dot"></i>${item.localizacao} - ${item.cidade}</div>
